...
class Notification {
  ...
  // Group conversation (room) avatar as base64 image bytes. With
  // `groupConversation`, it becomes the conversation icon (largeIcon) of the
  // MessagingStyle notification; sender avatars stay on the expanded rows.
